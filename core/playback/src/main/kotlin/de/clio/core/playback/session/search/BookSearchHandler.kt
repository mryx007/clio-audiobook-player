...
class BookSearchHandler(
  ...
  suspend fun handle(search: ClioSearch): Book? {
  ...
  private suspend fun searchAlbum(search: ClioSearch): Book? {
  ...
  private suspend fun searchByArtist(search: ClioSearch): Book? {
