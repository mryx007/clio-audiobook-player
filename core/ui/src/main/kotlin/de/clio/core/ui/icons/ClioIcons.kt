    ...
    ImageVector.Builder(
      ...
      .apply {
        path(
          ...
          quadToRelative(0f, 0.45f, 0.35f, 0.88f)
          reflectiveQuadToRelative(0.35f, 0.92f)
          quadToRelative(0f, 1.05f, -0.73f, 1.7f)
          reflectiveQuadTo(12f, 22f)
          close()
          moveTo(6.5f, 13f)
          quadToRelative(0.65f, 0f, 1.07f, -0.42f)
          reflectiveQuadTo(8f, 11.5f)
          reflectiveQuadToRelative(-0.43f, -1.08f)
          reflectiveQuadTo(6.5f, 10f)
          reflectiveQuadToRelative(-1.08f, 0.42f)
          reflectiveQuadTo(5f, 11.5f)
          reflectiveQuadToRelative(0.42f, 1.08f)
          ...
          close()
          moveTo(17.5f, 13f)
          quadToRelative(0.65f, 0f, 1.08f, -0.42f)
          reflectiveQuadTo(19f, 11.5f)
          reflectiveQuadToRelative(-0.42f, -1.08f)
          ...
          close()
          moveTo(12f, 20f)
          quadToRelative(0.35f, 0f, 0.53f, -0.15f)
          reflectiveQuadToRelative(0.17f, -0.5f)
          quadToRelative(0f, -0.45f, -0.35f, -0.85f)
          reflectiveQuadTo(12f, 17.55f)
          quadToRelative(0f, -1.15f, 0.78f, -1.85f)
          reflectiveQuadTo(14.55f, 15f)
          horizontalLineTo(16f)
          quadToRelative(2f, 0f, 3f, -1.15f)
          reflectiveQuadToRelative(1f, -2.8f)
          quadToRelative(0f, -3.3f, -2.35f, -5.17f)
          reflectiveQuadTo(12f, 4f)
          quadTo(8.7f, 4f, 6.35f, 6.35f)
          reflectiveQuadTo(4f, 12f)
