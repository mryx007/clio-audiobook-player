package de.clio.features.bookmark
...
import de.clio.features.bookmark.dialogs.AddBookmarkDialog
  ...
  Scaffold(
    ...
    floatingActionButton = {
      FloatingActionButton(
        onClick = onAdd,
        content = {
          Icon(imageVector = ClioIcons.Add, contentDescription = stringResource(id = StringsR.string.common_action_add))
        },
      )
    },
  ) { paddingValues ->
